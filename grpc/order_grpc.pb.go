...
const (
	OrderService_NewOrder_FullMethodName = "/proto.OrderService/NewOrder"
)
...
func (c *orderServiceClient) NewOrder(ctx context.Context, in *NewRequestOrder, opts ...grpc.CallOption) (*NewResponseOrder, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NewResponseOrder)
...
func (UnimplementedOrderServiceServer) NewOrder(context.Context, *NewRequestOrder) (*NewResponseOrder, error) {
...
func _OrderService_NewOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).NewOrder(ctx, req.(*NewRequestOrder))
	}
